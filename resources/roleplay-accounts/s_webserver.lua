...
function reconnectWebSQL()
	...
	web_connection = dbConnect(web_databaseConfig["type"], "dbname=" .. web_databaseConfig["database"] .. ";host=" .. web_databaseConfig["hostname"], web_databaseConfig["username"], web_databaseConfig["password"])
